<x-admin-layout>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="image-preview-wrapper cursor-pointer"
                            ...
                            <div id="placeholder"
                                class="upload-placeholder {{ $post->featured_image ? 'hidden' : '' }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            ...
                            <x-text-input id="published_at" name="published_at" type="datetime-local"
                                class="mt-1 block w-full" :value="old('published_at', $post->published_at ? $post->published_at->format('Y-m-d\TH:i') : '')" />
                    ...
                    <div class="flex items-center justify-end gap-4 border-t pt-8">
                        <a href="{{ route('admin.posts.index') }}"
                            class="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 transition-colors">Cancel</a>
                        <button type="submit"
    ...
    <script>
        const easymde = new EasyMDE({
            ...
            autosave: {
                enabled: true,
                uniqueId: "edit-post-editor-{{ $post->id }}",
                delay: 1000,
            },
